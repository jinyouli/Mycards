...
function c77402960.condition(e,tp,eg,ep,ev,re,r,rp)
	return (Duel.IsEnvironment(511000275,tp,LOCATION_FZONE) or Duel.IsEnvironment(41418852,tp,LOCATION_FZONE)) and Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0
end
