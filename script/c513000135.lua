...
function c513000135.initial_effect(c)
	...
	e1:SetCondition(c513000135.ttcon)
	e1:SetOperation(c513000135.ttop)
	...
	e6:SetCondition(c513000135.tgcon)
	e6:SetTarget(c513000135.tgtg)
	e6:SetOperation(c513000135.tgop)
	c:RegisterEffect(e6)
    ...
    e7:SetValue(c513000135.efilter)
    c:RegisterEffect(e7)
    ...
    e7:SetRange(LOCATION_MZONE)
    e7:SetCost(c513000135.descost)
    e7:SetTarget(c513000135.destg)
    e7:SetOperation(c513000135.desop)
    c:RegisterEffect(e7)
    ...
    e7:SetRange(LOCATION_MZONE)
    e7:SetCost(c513000135.descost)
    e7:SetOperation(c513000135.atkop)
    c:RegisterEffect(e7)

end

function c513000135.ttcon(e,c,minc)
	if c==nil then return true end
	return minc<=3 and Duel.CheckTribute(c,3)
end
function c513000135.ttop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectTribute(tp,c,3,3)
	c:SetMaterial(g)
	Duel.Release(g,REASON_SUMMON+REASON_MATERIAL)
end
function c513000135.setcon(e,c,minc)
...
function c513000135.tgcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_SPECIAL)
end
function c513000135.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,e:GetHandler(),1,0,0)
end
function c513000135.tgop(e,tp,eg,ep,ev,re,r,rp)
...
function c513000135.descost(e,tp,eg,ep,ev,re,r,rp,chk)
